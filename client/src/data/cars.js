const cars = [
  ...
  },
  {
    ...
    features: ['Apple CarPlay', 'Rear AC vents', 'Automatic gearbox', 'LED DRLs'],
    color: 'Silver',
    owners: 2,
  ...
  },
  {
    ...
    features: ['Sunroof', 'Push button start', 'Rear camera', 'Auto climate control'],
    color: 'Pearl White',
    owners: 1,
  ...
  },
  {
    ...
    features: ['7 Seater', 'Cruise control', 'Touchscreen system', 'Rear camera'],
    color: 'Black',
    owners: 2,
    insurance: 'Valid until 2027',
    sellerName: 'CarBazzar',
  ...
  },
  {
    ...
    features: ['Leather seats', 'Cruise control', 'Automatic transmission', 'LED headlamps'],
  ...
  },
  {
    ...
    features: ['DSG automatic', 'ESP with ABS', 'Touchscreen system', 'Climate control'],
    color: 'Blue',
    owners: 1,
    insurance: 'Valid until 2026',
    sellerName: 'CarBazzar',
